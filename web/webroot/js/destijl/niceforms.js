...
function textarea(el) { //extend Textareas
	...
	el.init = function() {
		...
		// el.style.width = el.topRight.style.width = el.bottomRight.style.width = 540 + 'px';
		// el.style.height = el.left.style.height = el.right.style.height = 100 + 'px';
...
function findPosY(obj) {
	var posTop = -15;
	do {posTop += obj.offsetTop;} while (obj != obj);
	return posTop;
}
function findPosX(obj) {
	var posLeft = 0;
	do {posLeft += obj.offsetLeft;} while (obj != obj);
	return posLeft;
}
//Get Siblings
